...
<body id="myPage">
	...
	<form action="product.htm">
		...
		<button style="display: none" id="orderHistory" name="orderHistory"></button>
	</form>
						...
						<div class="search-box">
						    ...
						    input.addEventListener("keyup", function(event) {
						      if (event.keyCode === 13) {
								...
								<input id="searchProduct" name="searchProduct"
					...
					<div class="col-md-6 col-sm-6 col-xs-12">
						<div class="user-value">
							<ul>
								<li class="dropdown"><a onclick="clickButton('login')"
									...
									<div class="dropdown-content" style="z-index: 2;">
										<a onclick="clickButton('changeInfor')"
											...
											style="color: white !important;">Change Password</a> <a
											onclick="clickButton('orderHistory')"
											style="color: white !important;">Order History</a> 
											<a
											href=report.htm style="color: white !important;">Report</a>
											<a
											onclick="clickButton('logout')"
											style="color: white !important;">Log out</a>
									</div>
								...
								<li class="cart-dropdown"><a onclick="displayCart()"> <i
										class="fa fa-shopping-basket" aria-hidden="true"></i> Cart
								</a>
				...
				<div class="container">
					...
					<nav class="collapse navbar-collapse">
						<ul class="nav navbar-nav navbar-left">
							<li class="active"><a onclick="clickButton('home')"
								class="flip-animate"><span data-hover="Home">Home</span></a></li>
	...
	window.onload = function() {
		...
		console.log("DSCART: "+ document.getElementById("DSCART").value);
								...
								<div class="toy-block">
									<div class="baby-image">
										...
										<form action="product/single.htm">
											<button id="singleProductButton${p.maSP }"
												style="display: none;"></button>
											<input name="singleProduct" id="singleProduct"
												value='${p.maSP }' style="display: none;" />
											<div class="toy-img">
												<a
													onclick="document.getElementById('singleProductButton${p.maSP }').click()">
													<img src="<c:url value='/resources/images/${p.hinhAnh }'/>"
