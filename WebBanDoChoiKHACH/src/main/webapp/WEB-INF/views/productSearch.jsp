...
<script type="text/javascript">
	...
	function addToCart(id, tenSP, gia, hinhAnh) {
		...
		{
			e.remove();
			document.getElementById("soLuongCart").innerText  = Number(document.getElementById("soLuongCart").innerText)-1;
			document.getElementById("allProduct").innerText  = Number(document.getElementById("allProduct").innerText)-1;
		}
						...
						<div class="user-value">
							<ul>
								<li class="dropdown"><a onclick="clickButton('login')"
									...
									<div class="dropdown-content" style="z-index: 2;">
										<a onclick="clickButton('changeInfor')"
											...
											<a
											href="cart/historyOrder" style="color: white !important;">Order History</a>
											<a
								...
								<li class="cart-dropdown"><a onclick="displayCart()"><i
										...
										id="soLuongCart" class="cart-item">0</span><span
										class="cart-tag">cart</span></a>
									<form action="product.htm" method="post">
										<div id="cart" class="dropdown-menu btn-block cartView"
											...
											<div id="cart-content" class="cart-content">
												...
												<div class="subtotal">
													<span>ALL</span> <span id="allProduct">0</span> <span
