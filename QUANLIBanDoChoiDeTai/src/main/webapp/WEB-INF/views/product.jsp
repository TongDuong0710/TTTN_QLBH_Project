								...
								<li class="dropdown"><a onclick="clickButton('login')"
									...
									<div class="dropdown-content" style="z-index: 2;">
										<a onclick="clickButton('changeInfor')"
											...
											<a
											onclick="clickButton('orderHistory')" style="color: white !important;">Order History</a>
											<a
											onclick="clickButton('logout')" style="color: white !important;">Log
											out</a>
									</div>
				...
				<div class="container">
					...
					<nav class="collapse navbar-collapse">
						<ul class="nav navbar-nav navbar-left">
							<li class="active"><a onclick="clickButton('home')" class="flip-animate"><span
