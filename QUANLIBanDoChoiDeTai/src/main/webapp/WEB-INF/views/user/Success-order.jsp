				...
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
							<h5 class="modal-title" style="font-size: large;">NOTIFICATION<a href="/WebBanDoChoi/user/${link}.htm"><button style=" float: right; margin-right: 5%;background-color: blue;border: none;border-radius: 4px" type="button" class="btn-close" onclick="Close()"
								data-dismiss="modal" aria-label="Close">
								<span aria-hidden="true">&times;</span>
							</button></a></h5>
							
						</div>
						<div class="modal-body" style="margin-left: 23%;
    margin-top: 2%;">
						<b style="align-content: center;font-size: larger;
    margin-left: 6%;">${message}</b>
							
						</div>
						<div class="modal-footer">
							<a href="/WebBanDoChoi/user/${link}.htm"><button type="button" class="btn btn-primary btn_Oke" style="border-color: none !"
