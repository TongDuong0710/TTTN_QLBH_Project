          ...
          <form:form action="update.htm" modelAttribute="Nhanvien" method="POST">
            <div class="p-3 py-5" style="margin-top: 27%;">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <h4 class="text-left"style="font-size: x-large;font-weight: 600;text-align: center;">PROFILE SETTING</h4>
                </div>
               
                <div class="row mt-3">
                <div class="col-md-12"><label class="labels">HỌ TÊN </label><form:input type="text" class="form-control"  path="hoten" /></div>
                <div class="col-md-12" style="display: none;"><label class="labels">MÃ NHÂN VIÊN</label><form:input type="text" class="form-control" path="manv" /></div>
                 <div class="col-md-12" style="display: none;"><label class="labels">HÌNH ẢNH</label><form:input type="text" class="form-control"  path="hinhanh" /></div>
                    <div class="col-md-12"><label class="labels">SỐ ĐIỆN THOẠI</label><form:input type="text" class="form-control" path="sdt" /></div>
                    <div class="col-md-12"><label class="labels">ĐỊA CHỈ</label><form:input type="text" class="form-control"  path="diachi" /></div>
                    <div class="col-md-12"><label class="labels">EMAIL</label><form:input type="text" class="form-control" path="email"/></div>
