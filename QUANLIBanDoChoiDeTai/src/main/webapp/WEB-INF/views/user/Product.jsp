	...
	<div id="wrapper">
		...
		<div id="page-wrapper">
			<div id="page-inner">
				<div class="row">
					<div class="col-md-12" >
						<h2 style="text-align: center;" class="title-form">LIST OF PRODUCT</h2>
						<span class="validatetion">${message}</span>
						
					</div>
					 <a href="/WebBanDoChoi/user/products/create.htm"><button type="button" class="btn btn-primary " style="float: right;margin-right: 3%;
    margin-top: 2%;" ><i class="fa fa-plus" aria-hidden="true"></i>  THÊM SẢN PHẨM</button></a>
				</div>
				<!-- /. ROW  -->
				<hr />
											...
											<c:forEach var="u" items="${products}">
												<tr>
													...
													<td><a class="btn-setting"
														href="/WebBanDoChoi/user/products/edit/${u.masp.trim()}.htm"
														onclick="showDiv()"><i class="bi bi-gear"></i></a> 
														
														<a
														class="btn-delete"
														href="/WebBanDoChoi/user/products/${u.masp.trim()}.htm"><i
