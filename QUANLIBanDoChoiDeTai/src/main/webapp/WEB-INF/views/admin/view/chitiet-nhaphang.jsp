...
<body>
	...
	<div style="display: flex; justify-content: space-between"
		...
		<div class="modal" id="modal">
			...
			<h3 class="tittle-header">CHI TIẾT NHẬP HÀNG</h3>
			<a class="btn-close" href="/WebBanDoChoi/nhapHang/importList.htm"></a>
			<div class="info" style="display: flex;flex-direction: column;">
				<div class="row">
				<div class="col">
				<label>MS Nhập Hàng:<span class="">${nhaphang.ID}</span></label>
				<br>
				</div>
				<div class="col">
				<label>Nhân Viên:<span class="">${nhaphang.tenNhanVien}</span></label>
				<br>
				</div>
				<label>Ngày Nhập:<span class=""> ${nhaphang.NGAYNHAP}</span></label>
				
			</div>
			</div>
			<hr  class="hr-form">
			<div class="body-form">
			<h5 class="title_sp" >DANH SÁCH SẢN PHẨM NHẬP</h5>
  ...
  <tbody>
    <c:forEach var="ctnh" items="${nhaphang.listDetail}">
    <tr>
  
      <th scope="row">${ctnh.tenSanPham}</th>
      <td><img alt="ảnh sản phẩm"  class="anhsp" src="/WebBanDoChoi/imageProducts/${ctnh.hinhAnhSP}"> </td>
      <td>${ctnh.SL}</td>
      <td>${ctnh.DONGIA}</td>
    </tr></c:forEach>
    </tbody>
			...
			<div class="row">
			<div class="col">
			<label style="">Tổng tiền:${tongTien} USD<span class="noidung"></span></label>
			</div>
			</div>
			</div>
			</div>
