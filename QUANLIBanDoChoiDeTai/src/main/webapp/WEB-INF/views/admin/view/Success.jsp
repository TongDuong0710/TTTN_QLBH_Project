...
<body>
				...
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
							<h5 class="modal-title" style="font-size: large;">Notification<a href="/WebBanDoChoi${link}.htm"><button style=" float: right; margin-right: 5%;background-color: blue;border: none;border-radius: 4px" type="button" class="btn-close" onclick="Close()"
    ...
    margin-left: 6%;">${message}</b>
						...
						<div class="modal-footer">
							<a href="/WebBanDoChoi${link}.htm"><button type="button" class="btn btn-primary btn_Oke" style="border-color: none !"
