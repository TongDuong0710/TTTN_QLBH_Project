	...
	<script type="text/javascript">
	 ...
	 window.onload = function() { 
		 ...
		 var chart = new CanvasJS.Chart("chartContainer", {
				title: {
					text: "THỐNG KÊ NHẬP HÀNG TRONG THÁNG"
				},
				axisX: {
					title: "Thời Gian"
				},
		 ...
		 function addDatatest(data) {
		    ...
		    $.getJSON("http://localhost:8082//findNhapHang/2000-07-10/2030-07-10.json", addDataChart2);
			$.getJSON("http://localhost:8082/findNhapHangThang/2000-07-10/2030-07-10.json", addData2);
			$('#addbtn').click(function() {
				...
				$.getJSON("http://localhost:8082//findNhapHangThang/"+startDate+"/"+endDate+".json", addData2);
				
				$.getJSON("http://localhost:8082//findNhapHang/"+startDate+"/"+endDate+".json", addDataChart2);
				
				$.getJSON("http://localhost:8082//findNhapHang/"+startDate+"/"+endDate+".json", 
		                function (data) {
		            var row = '';
				...
				$.getJSON("http://localhost:8082//findNhapHangThang/"+startDate+"/"+endDate+".json", 
		                function (data) {
		            var row = '';
		            $.each(data, function (key, value) {
		            	row += '<tr>';
...
<script type="text/javascript">
	...
	function exportData(e) {
		...
		link.setAttribute("download", "Thống Kê Nhập Hàng " + e + ".csv");
	...
	<div id="wrapper">
		...
		<div id="page-wrapper">
			<div id="page-inner">
				...
				<hr />
				<h1 style="text-align: center; font-family:sans-serif; ; color: red;" >BÁO CÁO NHẬP HÀNG</h1>
				<br>
				<br>
				...
				<button id='addbtn' class="btn btn-lg btn-primary btn-success">Tìm Kiếm</button>
					...
					<div class="col-md-12">
						...
						<div class="panel panel-default">
							<div class="panel-heading" style="font-weight: bold;">BẢNG NHẬP HÀNG THEO THÁNG</div>
									...
									<table class="table table-striped table-bordered table-hover"
										...
										<thead style="background-color: #0000000d;">
											<tr>
												...
												<th scope="col">Số lượng Đơn Nhập Hàng</th>
											</tr>
										</thead>
										 <tbody>
										</tbody>
				...
				<div class="row">
					<div class="col-md-12">
						...
						<div class="panel panel-default">
							<div class="panel-heading" style="font-weight: bold;">BẢNG NHẬP HÀNG THEO NGÀY</div>
							<div class="panel-body">
								<div class="table-responsive">
									<table class="table table-striped table-bordered table-hover"
										...
										<thead style="background-color: #0000000d;">
											<tr>
												<th scope="col">Date</th>
												<th scope="col">Tổng Tiền</th>
												<th scope="col">Số lượng Đơn Nhập</th>
											</tr>
										</thead>
										 <tbody>
										</tbody>
