										...
										<form:form action="insert.htm" modelAttribute="NV">
											...
											<div class="form-group">
												<label>Password</label> <form:input pattern="^(?=.*[A-Za-z])(?=.*\d)[A-Za-z\d]{8,}$" class="form-control"
													title="Must contain at least one  number and one uppercase and lowercase letter, and at least 8 or more characters" placeholder="Please enter a password" path="dstaikhoan.matkhau" />
