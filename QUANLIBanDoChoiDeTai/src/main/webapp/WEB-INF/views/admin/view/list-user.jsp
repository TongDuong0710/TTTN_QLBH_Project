...
<body>
	<div id="wrapper">
		...
		<div id="page-wrapper">
			<div id="page-inner">
				<div class="row">
					<div class="col-md-12">
						<h2 style="text-align: center;" class="title-form">LIST OF EMPLOYEE</h2>
    ...
    margin-top: -6%;" > <i class="fa fa-plus" aria-hidden="true"></i>  THÊM NHÂN VIÊN</button></a>
											...
											<c:forEach items="${listNV}" var="listNV">
												<tr class="odd gradeX">
													...
													<td><a
														...
														class="center"><i class="bi bi-gear"></i></a> | 
														<a class="center js-delete" name="${listNV.manv}"><i class="bi bi-trash"></i></a></tr>
											</c:forEach>
