...
public class ProductAPI {
	...
	public static List<SANPHAMk> findAllSP()
	{
		List<SANPHAMk> list = null;
		...
		try {
			...
			if (responseCode == HttpURLConnection.HTTP_OK) {
				...
				if(response.toString().trim().equals("")==false)
				{
					...
					list = Arrays.asList(mapper.readValue(response.toString(), SANPHAMk[].class));
				}
			} else {
	...
	public static List<SANPHAMk> findByLoaiSPOrderByDonGiaAsc(String loaiSP)
	{
		List<SANPHAMk> list = null;
	...
	public static List<SANPHAMk> findByLoaiSPOrderByDonGiaDesc(String loaiSP)
	{
		List<SANPHAMk> list = null;
	...
	public static List<SANPHAMk> findByLoaiSP(String loaiSP)
	{
		List<SANPHAMk> list = null;
	...
	public static List<SANPHAMk> findAllByOrderByDonGiaDesc()
	{
		List<SANPHAMk> list = null;
	...
	public static List<SANPHAMk> findAllByOrderByDonGiaAsc()
	{
		List<SANPHAMk> list = null;
	...
	public static List<SANPHAMk> findByTenSPContaining(String tenSP)
	{
		List<SANPHAMk> list = null;
	...
	public static SANPHAMk findOneByMaSP(String maSP)
	{
		SANPHAMk list = null;
		...
		try {
			...
			if (responseCode == HttpURLConnection.HTTP_OK) {
				...
				{
					ObjectMapper mapper = new ObjectMapper();
					list = mapper.readValue(response.toString(), SANPHAMk.class);
				}
			} else {
				System.out.println("GET request not worked");
			}
	...
	{
		int list = -1;
		String str= pubVar.apiString+"findMaxProductID";
		try {
			URL url = new URL(str);
			con= (HttpURLConnection)url.openConnection();
			con.setRequestMethod("GET");
	...
	public static List<SANPHAMk> findSanPhamDaXoa()
	{
		List<SANPHAMk> list = null;
		String str= pubVar.apiString+"findSanPhamDaXoa";
		try {
			URL url = new URL(str);
			con= (HttpURLConnection)url.openConnection();
			con.setRequestMethod("GET");
