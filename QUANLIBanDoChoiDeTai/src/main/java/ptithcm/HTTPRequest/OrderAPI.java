...
public class OrderAPI {
	...
	public static DDHk getOrderByID(Integer MSDDHk)
	{
		DDHk dh=null;
		OrderInput od=null;
		String str= pubVar.apiString+"order?MSDDHk="+MSDDHk;
		try {
			URL url = new URL(str);
	...
	public static List<DDHk> getHistoryOrder(int maKH)
	{
		List<DDHk> list = new ArrayList<DDHk>();
		...
		if(listOD!=null)
		{
			list= Convert.convertToListDDHk(listOD);
		}
		return list;
	}
	public static DDHk insertOrder(DDHk dh)
	{
...
//            dos.writeBytes(jsonInputString);
	...
	public static DDHk cancelOrder(DDHk dh)
	{
		OrderInput od= Convert.convertToOrderInput(dh);
...
//            dos.writeBytes(jsonInputString);
	...
	public static List<DDHk> getAll()
	{
		List<DDHk> list = new ArrayList<DDHk>();
		List<OrderInput> listOD=new ArrayList<OrderInput>();
		String str= pubVar.apiString+"getAllOrder";
		try {
			URL url = new URL(str);
			con= (HttpURLConnection)url.openConnection();
			con.setRequestMethod("GET");
